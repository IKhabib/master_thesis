...
This appendix collects the definitions and mathematical arguments used in
the main text and in the extended methodological appendices.  It supplies
the full supporting proofs without interrupting the main exposition.  A definition fixes the meaning of a term and therefore is not a
...
$\mathcal H_{\mathrm{id}}$.  Appendix~\ref{chap:inference-methodology} writes
