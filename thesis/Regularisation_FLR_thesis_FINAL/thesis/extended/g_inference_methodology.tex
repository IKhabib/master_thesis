% Extended inference methodology for the late-stopped CG--FPLS path.
\chapter{Extended Inference Methodology}
\label{chap:inference-methodology}

This appendix develops the testing, calibration, and confidence-set methodology summarised in
Chapter~\ref{chap:main-inference}.

Appendix~\ref{chap:estimation-results} showed that stopping CG--FPLS early can
...
root-$n$ sampling fluctuation.  This appendix explains why that requirement
...
from Appendix~\ref{chap:estimation-results}.  The appendix introduces the
...
Appendix~\ref{chap:inference-results}.
...
\eqref{main:eq-inference-statistic}.  The calligraphic symbol $\mathcal T_n$
denotes this scalar statistic; $T_n$ continues to denote the sampling
operator introduced in Appendix~\ref{chap:methods}.
...
calibration.  Appendix~\ref{chap:inference-results} therefore provides no
...
\end{enumerate}
The shaded region in Appendix~\ref{chap:inference-results} combines the
...
Appendix~\ref{chap:methods}, with $\tau=1.01$ and
...
variant of the procedure in Appendix~\ref{chap:estimation-results}.
...
Appendix~\ref{chap:methods}.  Both methods use an orthogonal Krylov basis, but
...
direct statistic.  Appendix~\ref{chap:inference-results} therefore begins
